...
const DarkModeButton = ({theme,toggleTheme})=>{
  ...
  return(
    ...
    <label htmlFor='theme' role='button' className='select-none font-semibold'>{theme === 'light'? "Light" : "Dark"}</label>
    <label className="swap swap-rotate ">

{/* this hidden checkbox controls the state */}
<input type="checkbox" id='theme' className="theme-controller" checked={theme === 'light'? false : true} value="synthwave" onChange={toggleTheme}/>
